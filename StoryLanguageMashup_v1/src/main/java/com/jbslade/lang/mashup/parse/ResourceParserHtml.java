...
public class ResourceParserHtml extends ResourceParser<Story>
{
    ...
    public ArrayList<Story> getResourceParsedElems(InputStream is)
    {
        ...
        try
        {
            ...
            story.setForeignText(m_fullStory);
    ...
    private void processLine(String line)
    {
        ...
        else
        {
            ...
            if (m.find())
            {
                ...
                m_fullStory += (line.substring(0, m.start()) + "\n\t");
    ...
    {
        for (String tag : htmlRemoveTagBodies)
        {
//            fullStory = fullStory.replaceAll("<" + tag + ".*?>.*?</" + tag + ".*?>", "");
    ...
    {
        int oldLength = fullStory.length();
